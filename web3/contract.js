const contractAddress = "0x508ae0adfa87403ab745f24381bc4632556b938f";
const stableCoinAddress = "0x855e5f4917Bb78E1Fbd6962D03A0993f8F5033Cb";
const contractABI = [
  {
    inputs: [
      { internalType: "address", name: "stableCoin_", type: "address" },
      { internalType: "address", name: "_gloabalInsurance", type: "address" },
      { internalType: "address", name: "_liquidityPool", type: "address" },
      { internalType: "address", name: "_tokenBuyBack", type: "address" },
      { internalType: "address", name: "_roundCloser", type: "address" },
    ],
  ...
  },
  {
    ...
    name: "reports",
    outputs: [
      { internalType: "uint256", name: "firstTO", type: "uint256" },
      { internalType: "uint256", name: "secondTO", type: "uint256" },
      { internalType: "uint256", name: "thirdTO", type: "uint256" },
      { internalType: "uint256", name: "fourthTO", type: "uint256" },
      { internalType: "address", name: "first", type: "address" },
      { internalType: "address", name: "second", type: "address" },
      { internalType: "address", name: "third", type: "address" },
      { internalType: "address", name: "fourth", type: "address" },
      { internalType: "uint256", name: "top4PoolForwarded", type: "uint256" },
      { internalType: "uint256", name: "top4Pool", type: "uint256" },
      { internalType: "uint256", name: "top4Pool2Distribute", type: "uint256" },
      { internalType: "uint256", name: "actualTO", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
...
async function connectWallet() {
  ...
  if (typeof window.ethereum !== "undefined") {
    ...
    console.log("Its calling Connect Wallet : ", connectedAddress);
...
async function payNow() {
  ...
  try {
    ...
    //Registration (0x0b177cf4)
    await contractInstance.methods
      .Registration(referralId, nodeQuantity)
      .send({ from: connectedAddress, value: 0 });
    console.log("Pay now is called");
  } catch (e) {
