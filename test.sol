...
contract KBC_GLOBAL {
    ...
    function Registration(uint _referrerID) public payable {
        ...
        require(InsurancePoolActive == false,"Project closed");
            ...
            uint usdtPrice = (wBNB.balanceOf(pricePool) * 1e18 / stableCoin.balanceOf(pricePool));
        require(msg.value >= usdtPrice * 100,"Value must be Greater then 100 USDT");
    ...
    function topUp() public payable {
        require(users[msg.sender].isExist, "User not Exists");
         ...
         require(msg.value >= (lastTopup[msg.sender] * 1e18) / Kbc_Price,"Value must be Greater then last topup");
             uint _amount = ((msg.value * 1e18) / usdtPrice);
        ...
        income[userList[users[msg.sender].referrerID]].directIncome += _amount /20;
        income[userList[users[msg.sender].referrerID]].totalIncome += _amount /20;
        income[userList[users[msg.sender].referrerID]].balanceIncome += _amount /20;

        payable(ownerWallet).transfer(msg.value / 50);
        globalPool += msg.value * 88 / 100;
        insurancePool += msg.value / 10;
    ...
    function top4PoolDistribution(
       ...
       if( reportsUSDT[currRound].fourthUSDT== userList[_referrerID]){
         ...
         if( reportsUSDT[currRound].thirdUSDT== userList[_referrerID]){
            reportsUSDT[currRound].thirdTOUSDT += _amount;
        }
         if( reportsUSDT[currRound].secondUSDT== userList[_referrerID]){
            reportsUSDT[currRound].secondTOUSDT += _amount;
        }
         if( reportsUSDT[currRound].firstUSDT== userList[_referrerID]){
            reportsUSDT[currRound].firstTOUSDT += _amount;
        }

            if (reportsUSDT[currRound].thirdTOUSDT < reportsUSDT[currRound].fourthTOUSDT) {
                replaceTo = reportsUSDT[currRound].thirdTOUSDT;
                currentRunner = reportsUSDT[currRound].thirdUSDT;

                reportsUSDT[currRound].thirdTOUSDT = reportsUSDT[currRound].fourthTOUSDT;
                reportsUSDT[currRound].thirdUSDT = reportsUSDT[currRound].fourthUSDT;
                ...
                if (
                    ...
                    reportsUSDT[currRound].secondTOUSDT = reportsUSDT[currRound].thirdTOUSDT;
                    reportsUSDT[currRound].secondUSDT = reportsUSDT[currRound].thirdUSDT;
                    ...
                    if (
                        ...
                        reportsUSDT[currRound].firstTOUSDT = reportsUSDT[currRound].secondTOUSDT;
                        reportsUSDT[currRound].firstUSDT = reportsUSDT[currRound].secondUSDT;
        ...
        if (block.timestamp - currRoundStartTime >= 86400) {
            ...
            income[reportsUSDT[currRound].firstUSDT].top4Income +=
             ((reportsUSDT[currRound].top4PoolUSDT * 20) / 100);
            ...
            income[reportsUSDT[currRound].secondUSDT].top4Income +=
             ((reportsUSDT[currRound].top4PoolUSDT * 15) / 100);
       ...
       if (((reward * 1e18) / Kbc_Price) > globalPool){
        ...
        uint inctosend = income[msg.sender].balanceIncome;
        if (inctosend >= users[msg.sender].capping - totalTaken[msg.sender]) {
        ...
        if (_star ==1){
            ...
            require(userTeamSize[msg.sender] >= 15, "team size is less then 15");
            require(userTurnOver[msg.sender] >= 3100e18, "turnover is less then 3100");
            require(totalDeposit[msg.sender] >= 100e18, "self deposit is below 100");
        ...
        if (_star ==2){
            ...
            require(users[msg.sender].referredUsers >= 7, "refer 5 users first");
            //require(users[msg.sender].levelIncomeReceived >= 25, "team size is less then 25");
            require(userTeamSize[msg.sender] >= 30, "team size is less then 30");
            require(userTurnOver[msg.sender] >= 10300e18, "turnover is less then 10300");
            require(totalDeposit[msg.sender] >= 300e18, "self deposit is below 300");
        ...
        if (_star ==3){
            ...
            require(users[msg.sender].referredUsers >= 8, "refer 8 users first");
            //require(users[msg.sender].levelIncomeReceived >= 50, "team size is less then 50");
            require(userTeamSize[msg.sender] >= 50, "team size is less then 50");
            require(userTurnOver[msg.sender] >= 30500e18, "turnover is less then 30500");
            require(totalDeposit[msg.sender] >= 500e18, "self deposit is below 300");
        ...
        if (_star ==4){
            ...
            require(users[msg.sender].referredUsers >= 10, "refer 10 users first");
            //require(users[msg.sender].levelIncomeReceived >= 100, "team size is less then 10");
            require(userTeamSize[msg.sender] >= 100, "team size is less then 100");
            require(userTurnOver[msg.sender] >= 101000e18, "turnover is less then 101000");
            require(totalDeposit[msg.sender] >= 1000e18, "self deposit is below 1000");
        ...
        if (_star ==5){
            ...
            require(users[msg.sender].referredUsers >= 12, "refer 12 users first");
            //require(users[msg.sender].levelIncomeReceived >= 200, "team size is less then 10");
            require(userTeamSize[msg.sender] >= 200, "team size is less then 200");
            require(userTurnOver[msg.sender] >= 1000000e18, "turnover is less then ten lac");
            require(totalDeposit[msg.sender] >= 5000e18, "self deposit is below 5000");
        ...
        if (_star ==6){
            ...
            require(userTeamSize[msg.sender] >= 500, "team size is less then 500");
            require(userTurnOver[msg.sender] >= 5000000e18, "turnover is less then fifty lac");
            require(totalDeposit[msg.sender] >= 10000e18, "self deposit is below 10000");
        ...
        if (_star ==7){
            ...
            require(userTeamSize[msg.sender] >= 1000, "team size is less then 1000");
            require(userTurnOver[msg.sender] >= 20000000e18, "turnover is less then 2 Cr");
            require(totalDeposit[msg.sender] >= 25000e18, "self deposit is below 25k");
